...
$sql = "SELECT * FROM daftar_mhs WHERE id=$id";
...
<body>
	...
	<form action="proses-edit.php" method="POST">
		...
		<p>
			<label for="judulta">Sekolah Asal: </label>
			<input type="text" name="judulta" placeholder="judulta" value="<?php echo $mahasiswa['judulta'] ?>" />
		</p>
		<p>
